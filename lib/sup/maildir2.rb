...
class Maildir2 < Source
  ...
  def initialize uri, cur_offset=nil, usual=true, archived=false, id=nil, labels=[], mtimes={}
    super uri, cur_offset, usual, archived, id
    ...
    @log = File.open(File.join(@dir, '.log'), 'r+')
